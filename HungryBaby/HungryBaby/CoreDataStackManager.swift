...
private let SQLITE_FILE_NAME = "HungryBaby.sqlite"
...
class CoreDataStackManager {
    ...
    */
    ...
    lazy var managedObjectModel: NSManagedObjectModel = {
        ...
        let modelURL = NSBundle.mainBundle().URLForResource("HungryBaby", withExtension: "momd")!
    ...
    lazy var persistentStoreCoordinator: NSPersistentStoreCoordinator? = {
        ...
        do {
            ...
            let wrappedError = NSError(domain: "HungryBaby", code: 9999, userInfo: dict)
